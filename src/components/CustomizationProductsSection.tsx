    ...
    return (
        <section className="py-4">
            <div className="mx-auto max-w-6xl px-4">
                ...
                <h2 className="mb-4 text-2xl font-bold tracking-wide border-b-4 border-yellow-600 inline-block pb-2">
                    ...
                    {products.map((item, i) => (
                        ...
                        >
                            ...
                            <a
                                ...
                                target="_blank"
                                className="mt-2 block rounded-lg border border-black px-3 py-2 text-center text-xs font-medium text-black hover:bg-green-500"
                            >
                                Connect with Us
                            </a>
                        </div>
